...
## Overview
#### This project was developed as part of an advanced Databases: Big Data & Analytics curriculum. It delivers an end-to-end data engineering and business intelligence solution designed to process, model, and analyze over 5.8 million transactional flight records from the U.S. Department of Transportation (DOT).
